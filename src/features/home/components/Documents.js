...
const Documents = ({
  ...
  data,
  horizontal = false,
  showIcons = false, // Hiển thị các icon trong footer
  viewAll = 'Tất Cả', // Văn bản nút xem tất cả (mặc định "Tất Cả")
  iconName = null, // Tên icon, mặc định không hiển thị icon
  iconColor = '#034567', // Màu của icon, mặc định xanh
}) => {
  return (
    <View style={styles.featuredCard}>
      <View style={styles.header}>
        ...
        {viewAll && (
          <TouchableOpacity onPress={() => navigation.navigate('AllDocumentScreen')}>
            ...
            <View style={styles.footer}>
              {showIcons && (
                <View style={styles.iconContainer}>
                  ...
                  <TouchableOpacity style={styles.iconButton}>
                    <Image
                      source={require('../../../assets/icons/icon_Share.png')}
                    />
                  </TouchableOpacity>
                </View>
              )}
              ...
              <TouchableOpacity
                ...
                onPress={() => navigation.navigate('DocumentDetail', { item })}
              >
